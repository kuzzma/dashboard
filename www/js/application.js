...
(function() {
  ...
  source = new EventSource('http://dashboard.x-cart.com/events');
...
(function() {
  ...
  Dashing.Bitbucket = (function(_super) {
    __extends(Bitbucket, _super);

    function Bitbucket() {
      _ref = Bitbucket.__super__.constructor.apply(this, arguments);
      return _ref;
    }
...
(function() {
  ...
  Dashing.Calendar = (function(_super) {
    __extends(Calendar, _super);

    function Calendar() {
      this.startCountdown = __bind(this.startCountdown, this);
      this.nextEvent = __bind(this.nextEvent, this);
      _ref = Calendar.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Calendar.prototype.ready = function() {
      this.currentIndex = 0;
      this.eventElement = $(this.node).find('.event-container');
      this.nextEvent();
      this.startCarousel();
      return setInterval(this.startCountdown, 500);
    };

    Calendar.prototype.onData = function(data) {
      return this.currentIndex = 0;
    };

    Calendar.prototype.startCarousel = function() {
      return setInterval(this.nextEvent, 16000);
    };

    Calendar.prototype.nextEvent = function() {
      var events,
        _this = this;
      events = this.get('events');
      if (events) {
        return this.eventElement.fadeOut(function() {
          _this.currentIndex = (_this.currentIndex + 1) % events.length;
          _this.set('current_event', events[_this.currentIndex]);
          return _this.eventElement.fadeIn();
        });
      }
    };

    Calendar.prototype.startCountdown = function() {
      ...
      end_timestamp = Math.round(Date.parse($(this.node).find(".start").text()) / 1000);
    ...
    Calendar.prototype.formatTime = function(i) {
      if (i < 10) {
        return "0" + i;
      } else {
        return i;
...
(function() {
  ...
  Dashing.Comments = (function(_super) {
    ...
    Comments.prototype.startCarousel = function() {
      return setInterval(this.nextComment, 16000);
    };
    ...
    Comments.prototype.nextComment = function() {
      ...
      if (comments) {
        return this.commentElem.fadeOut(function() {
          ...
          console.log(comments[_this.currentIndex]);
...
(function() {
  ...
  Dashing.Countdown = (function(_super) {
    ...
    function Countdown() {
      this.workDaysLeft = __bind(this.workDaysLeft, this);
      this.startCountdown = __bind(this.startCountdown, this);
      _ref = Countdown.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    Countdown.prototype.isWorkDay = function(date) {
      ...
      if (date.getFullYear() === 2014) {
        if (date.getMonth() === 0) {
          if ((_ref2 = date.getDate()) === 1 || _ref2 === 2 || _ref2 === 3 || _ref2 === 7) {
            return false;
          }
          if ((_ref3 = date.getDate()) === 4 || _ref3 === 5) {
            return true;
          }
        }
        if (date.getMonth() === 2) {
          if ((_ref4 = date.getDate()) === 8) {
            return false;
          }
        }
        if (date.getMonth() === 4) {
          if ((_ref5 = date.getDate()) === 1 || _ref5 === 2 || _ref5 === 9) {
            return false;
          }
        }
        if (date.getMonth() === 5) {
          if ((_ref6 = date.getDate()) === 12) {
            return false;
          }
        }
        if (date.getMonth() === 10) {
          if ((_ref7 = date.getDate()) === 4) {
            return false;
          }
        }
        if (date.getMonth() === 11) {
          if ((_ref8 = date.getDate()) === 30 || _ref8 === 31) {
            return false;
          }
        }
      }
      if ((_ref9 = date.getDay()) === 0 || _ref9 === 6) {
        return false;
      }
      return true;
    };

    Countdown.prototype.workDaysLeft = function() {
      var current_timestamp, days, end_timestamp;
      current_timestamp = new Date();
      end_timestamp = new Date(Date.parse($(this.node).find(".more-info").html()));
      days = 0;
      while (!(current_timestamp.getDate() === end_timestamp.getDate() && current_timestamp.getMonth() === end_timestamp.getMonth())) {
        if (this.isWorkDay(current_timestamp)) {
          days++;
        }
      ...
      if (days > 10) {
        days -= 10;
        return this.set('workdays', days + ' working day' + (days > 1 ? 's' : ''));
      } else {
        $(this.node).find(".workdays").removeClass('redline').addClass('redline');
        return this.set('workdays', days + ' redline day' + (days > 1 ? 's' : ''));
      }
    };
...
(function() {
  ...
  Dashing.Xcartcountdown = (function(_super) {
    __extends(Xcartcountdown, _super);

    function Xcartcountdown() {
      this.workDaysLeft = __bind(this.workDaysLeft, this);
      this.startCountdown = __bind(this.startCountdown, this);
      _ref = Xcartcountdown.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Xcartcountdown.prototype.ready = function() {
      setInterval(this.startCountdown, 500);
      setInterval(this.workDaysLeft, 60000);
      return this.workDaysLeft();
    };

    Xcartcountdown.prototype.startCountdown = function() {
      var current_timestamp, d, dayname, end_timestamp, h, i, m, s, seconds_until_end, _i, _results;
      current_timestamp = Math.round(new Date().getTime() / 1000);
      end_timestamp = Math.round(Date.parse($(this.node).find(".more-info").html()) / 1000);
      seconds_until_end = end_timestamp - current_timestamp;
    ...
    Xcartcountdown.prototype.isWorkDay = function(date) {
      var _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (date.getFullYear() === 2013) {
        if (date.getMonth() === 11) {
          if ((_ref1 = date.getDate()) === 30 || _ref1 === 31) {
    ...
    Xcartcountdown.prototype.workDaysLeft = function() {
      var current_timestamp, days, end_timestamp;
      current_timestamp = new Date();
      end_timestamp = new Date(Date.parse($(this.node).find(".more-info").html()));
      days = 0;
    ...
    Xcartcountdown.prototype.formatTime = function(i) {
      if (i < 10) {
        return "0" + i;
      } else {
        return i;
